...
/**
  * @brief  this function handles EXINT Line 4 handler.
  * @param  none
  * @retval none
  */
void EXINT4_IRQHandler(void)
{
  /* add user code begin EXINT4_IRQ 0 */

  /* add user code end EXINT4_IRQ 0 */
  /* add user code begin EXINT4_IRQ 1 */

  /* add user code end EXINT4_IRQ 1 */
}
